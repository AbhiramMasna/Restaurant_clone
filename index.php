		...
		<ul class="slides-container">
			<li class="text-left">
				...
				<div class="container">
					<div class="row">
						<div class="col-md-12">
							<h1 class="m-b-20"><strong>Welcome To <br> Sriram Anna Restaurant</strong></h1>
				...
				<div class="container">
					<div class="row">
						<div class="col-md-12">
							...
							<p class="m-b-40">Sriram Restaurant is serving a Authentic Hyderabadi Food.And Restaurant's
<br>
			...
			<li class="text-left">
				...
				<div class="container">
					<div class="row">
						<div class="col-md-12">
							<h1 class="m-b-20"><strong>Welcome To <br> YummyFood with Sriram</strong></h1>
			...
			<div class="row">
				<div class="col-lg-6 col-md-6 col-sm-12 text-center">
					<div class="inner-column">
						<h1>Welcome To <span>Sriram Anna Restaurant</span></h1>
						<h4>Little Story</h4>
						<p>Restaurants in Hyderabad, Ahmedabad Restaurants, Bopal restaurants, Best Bopal restaurants, West Ahmedabad restaurants, Gujarati Restaurants in Ahmedabad, Gujarati near me, Gujarati Restaurants in West Ahmedabad,
		...
		<div class="container">
			<div class="row">
				<div class="col-md-8 ml-auto mr-auto text-center">
					...
					<span class="lead">Sriram Anna Restaurent</span>
				</div>
			</div>
		</div>
	</div>
			...
			<div class="row inner-menu-box">
				<div class="col-3">
					<div class="nav flex-column nav-pills" id="v-pills-tab" role="tablist" aria-orientation="vertical">
						...
						<a class="nav-link" id="v-pills-profile-tab" data-toggle="pill" href="#v-pills-profile" role="tab" aria-controls="v-pills-profile" aria-selected="false">Hyderabadi</a>
